...
<head>
    ...
    <!-- Animate CSS -->
    <link rel="stylesheet" href="{{ asset('assets/front-end/assets/css/animate.css') }}">
    <!-- Boxicons CSS -->
    <link rel="stylesheet" href="{{ asset('assets/front-end/assets/css/boxicons.min.css') }}">
    <!-- Flaticon CSS -->
    <link rel="stylesheet" href="{{ asset('assets/front-end/assets/css/flaticon.css') }}">
    <!-- Meanmenu CSS -->
    <link rel="stylesheet" href="{{ asset('assets/front-end/assets/css/meanmenu.css') }}">
    <!-- Nice Select CSS -->
    <link rel="stylesheet" href="{{ asset('assets/front-end/assets/css/nice-select.css') }}">
    <!-- Odometer CSS-->
    <link rel="stylesheet" href="{{ asset('assets/front-end/assets/css/odometer.css') }}">
    <!-- Style CSS -->
    <link rel="stylesheet" href="{{ asset('assets/front-end/assets/css/style.css') }}">
    <!-- Responsive CSS -->
    <link rel="stylesheet" href="{{ asset('assets/front-end/assets/css/responsive.css') }}">

    <!-- Favicon -->
    <link rel="assetsi'assets/front-end/n" type="image/png"
        href="{{ asset('assets/front-end/assets/img/favicon.png') }}">
